...
const config = { theme, corePlugins, plugins, content, darkMode, safelist, prefix, variants, presets, important, separator, blocklist }
export { config as default, theme, corePlugins, plugins, content, darkMode, safelist, prefix, variants, presets, important, separator, blocklist }