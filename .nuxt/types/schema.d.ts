...
declare module '@nuxt/schema' {
  interface NuxtOptions {
    ...
    /**
     * Configuration for `@cssninja/nuxt-toaster`
     */
    ["toaster"]: typeof import("@cssninja/nuxt-toaster").default extends NuxtModule<infer O> ? O : Record<string, any>
    /**
  ...
  interface NuxtConfig {
    ...
    modules?: (undefined | null | false | NuxtModule<any> | string | [NuxtModule | string, Record<string, any>] | ["@nuxt/icon", Exclude<NuxtConfig["icon"], boolean>] | ["@nuxtjs/color-mode", Exclude<NuxtConfig["colorMode"], boolean>] | ["@nuxtjs/tailwindcss", Exclude<NuxtConfig["tailwindcss"], boolean>] | ["@nuxt/ui", Exclude<NuxtConfig["ui"], boolean>] | ["vue3-carousel-nuxt", Exclude<NuxtConfig["vue3-carousel-nuxt"], boolean>] | ["@cssninja/nuxt-toaster", Exclude<NuxtConfig["toaster"], boolean>] | ["shadcn-nuxt", Exclude<NuxtConfig["shadcn"], boolean>] | ["@nuxt/devtools", Exclude<NuxtConfig["devtools"], boolean>] | ["@nuxt/telemetry", Exclude<NuxtConfig["telemetry"], boolean>])[],
  }
}
declare module 'nuxt/schema' {
  interface NuxtOptions {
    ...
    /**
     * Configuration for `@cssninja/nuxt-toaster`
     * @see https://www.npmjs.com/package/@cssninja/nuxt-toaster
     */
    ["toaster"]: typeof import("@cssninja/nuxt-toaster").default extends NuxtModule<infer O> ? O : Record<string, any>
    /**
     * Configuration for `shadcn-nuxt`
